...
export default class TypoSection extends React.Component {
  render() {

      return (
        <section class="section section--typo">

  <h1>Typo</h1>

	<h1>Lorem ipsum dolor (h1)</h1>
  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cupiditate eveniet perferendis a laborum iure sunt culpa explicabo laboriosam, blanditiis ex molestias repellendus dolores, fugiat eum dolore, minima porro quaerat neque.</p>
	...
	<table class="listTable">
		...
		<tbody>
			<tr>
				...
				<td>Deprecated.</td>
				<td>Lorem ipsum <font color="green">dolor</font> sit amet</td>
			</tr>
			<tr>
				<td>Striketrough</td>
				<td><code>&lt;s&gt;</code></td>
