...
export default class PieChart extends React.Component {
  ...
  render() {
    ...
    let decoStrokeDasharray = this.props.decoStrokeDasharray || decoStrokeDashWidth + "," + (decoC / (unitAll || 100) - decoStrokeDashWidth)  || "1,3";
    let c = 2 * rArch * Math.PI; // circumference of deco circle
    let strokeDasharray = this.props.strokeDasharray || (c / (unitAll / 10) - decoStrokeDashWidth) + "," + decoStrokeDashWidth || "";
    ...
    return (
      <svg className={"pie-chart pie-chart--" + pieClassModifier} width={width} height={height} xmlns="http://www.w3.org/2000/svg">
